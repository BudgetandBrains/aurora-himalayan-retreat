    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 w-full h-full">
        ...
        >
          ...
          <CarouselPrevious className="left-4 z-20 bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm" />
          <CarouselNext className="right-4 z-20 bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm" />
        </Carousel>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="font-bodoni-regular text-4xl md:text-6xl lg:text-7xl font-normal text-white mb-2 text-balance">
          Aurora Farmstay
        </h1>
